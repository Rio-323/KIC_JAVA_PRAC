	...
	<input type="hidden" name="cpage" value="<%=cpage %>" />
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th class="top">글쓴이</th>
					<td class="top" colspan="3"><input type="text" name="writer" value="<%=album_writer %>" class="board_view_input_mail" maxlength="5" /></td>
				</tr>
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="subject" value="<%=album_subject %>" class="board_view_input" /></td>
				</tr>
				<tr>
					<th>비밀번호</th>
			...
			<div class="btn_area">
				<div class="align_left">			
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./view.do?cpage=<%= albumTO.getSeq() %>'" />
				</div>
				<div class="align_right">			
					<input type="button" value="삭제" class="btn_list btn_txt02" style="cursor: pointer;" id="submit1" />					
				</div>	
			</div>	
			<!--//게시판-->
		</div>
