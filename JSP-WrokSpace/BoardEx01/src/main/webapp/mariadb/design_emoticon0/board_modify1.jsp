...
<%
	...
	try {
		...
		String sql = "select subject, writer, mail, content, emot from emot_board where seq=?";
						...
						<td align="center">
							...
							<tr>
								...
								<td>
									...
									<input type="radio" name="emot" value="emot38" class="input_radio" <%= emot.equals("28") ? "checked='checked'" : "" %> />
								</td>
								<td>
