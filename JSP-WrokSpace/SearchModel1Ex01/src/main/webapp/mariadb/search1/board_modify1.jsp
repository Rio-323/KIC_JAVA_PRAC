		...
		<div class="contents_sub">	
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<button type="button" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='board_view1.jsp?searchKey=<%=searchKey %>&searchWord=<%=searchWord %>&seq=<%=seq %>'">보기</button>
				</div>
				<div class="align_right">
					<button type="button" id="mbtn" class="btn_write btn_txt01" style="cursor: pointer;">수정</button>
				</div>
			</div>
			<!--//게시판-->
		</div>
