...
//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ6. 선수 수정 패널ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
		...
		btn_6_SearchPlayer.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String[] playerBirth = to.get(0).getPlayerBirth().split("/");
				...
				textField_6_Year.setText( playerBirth[2] );
				textField_6_Month.setText( playerBirth[1] );
				textField_6_Day.setText( playerBirth[0] );
